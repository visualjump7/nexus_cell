    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div 
          ...
          style={{
            background: 'radial-gradient(ellipse at center, #ff6b3520 0%, transparent 70%)'
          }}
        />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-block">
            <h1 className="text-3xl font-extralight tracking-tight text-white">
              PROMPT <span className="font-bold text-orange-500">ARMORY</span>
            </h1>
          </Link>
        ...
        <div className="bg-white/[0.02] border border-white/10 rounded-xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label htmlFor="displayName" className="block text-xs text-white/50 uppercase tracking-wider mb-2">
                Display Name
              </label>
              <input
                id="displayName"
            ...
            <div>
              <label htmlFor="password" className="block text-xs text-white/50 uppercase tracking-wider mb-2">
                Password
              </label>
              <input
                id="password"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-xs text-white/50 uppercase tracking-wider mb-2">
                Confirm Password
              </label>
              <input
                id="confirmPassword"
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-orange-500 hover:bg-orange-600 text-black font-medium py-3 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex items-center justify-center gap-2 bg-white/[0.03] border border-white/10 rounded-lg py-3 text-white/80 hover:bg-white/[0.06] hover:border-white/20 transition-colors"
            >
